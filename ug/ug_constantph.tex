...
\begin{figure}[h]\centering
  ...
  \end{subfigure}% this is needed for avoiding a line break
  ~
  \begin{subfigure}{0.5\textwidth}\centering
    \simbox{\schemestart
      E-R$_1$H:R$_2$H
...
After this (or if an even number of arguments is specified) all remaining
  ...
  of the form \ARG{segid}:\ARG{resid}/\ARG{segid}:\ARG{resid}/\ldots.
}
\end{itemize}
...
{
\ARG{segid}:\ARG{resid} \ARG{state} 
  \OARG{\OARG{\ARG{segid}:\ARG{resid} \ARG{state}} \ldots}
}
{
...
{
\ARG{segid}:\ARG{resid} \ARG{pKai} 
  \OARG{\OARG{\ARG{segid}:\ARG{resid} \ARG{pKai}} \ldots}
}
{
...
{
\ARG{segid}:\ARG{resid} \OARG{\OARG{\ARG{segid}:\ARG{resid}} \ldots}
}
{
